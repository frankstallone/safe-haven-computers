...
<![endif]-->
    ...
    <div class="wrapper clearfix">
	    <aside class="definition">
	        <div class="row">
	            <div class="lock-it"><i class="icon-key"></i></div>
	            <div class="small-12 large-9 large-offset-3 columns text-right">
	                <h2><strong>Safe haven</strong>, <em>noun</em>: a place where you are protected from harm or danger.</h2>
	            </div>
	        </div>
	    </aside>
	        <article class="who-we-are home">
	            <div class="row">