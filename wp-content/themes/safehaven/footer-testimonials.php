        ...
        <div class="box-orange shc-tech">
            <div class="row">
              <!-- <div class="group"><i class="icon-group"></i></div> -->
                      ...
                      <section class="section">
                        ...
                        <div class="content clearfix">
                          ...
                          <div class="large-7 columns">
                              ...
                              <p class="small pull-right"><a href="/about/frank-senkewicz/">Read More <i class="icon-double-angle-right"></i></a></p>
                          </div>
                        </div>
                      </section>
                      <section class="section">
                        ...
                        <div class="content clearfix">
                          ...
                          <div class="large-7 columns">
                              ...
                              <p class="small pull-right"><a href="/about/steve-merzena/">Read More <i class="icon-double-angle-right"></i></a></p>
                          </div>
                        </div>
                      </section>
                ...
                <!-- <div class="large-5 columns testimonial">
