...
function reverie_scripts_and_styles() {
  if (!is_admin()) {
    ...
    wp_register_script('jquery', "https" . ($_SERVER['SERVER_PORT'] == 443 ? "s" : "") . "://ajax.googleapis.com/ajax/libs/jquery/2.0.0/jquery.min.js", false, null, true);
    
    // adding Foundation scripts file in the footer
    wp_register_script( 'foundation-js', get_template_directory_uri() . '/js/foundation/foundation.js', array( 'jquery' ), '', true );

    // adding Foundation Topbar file in the footer
    wp_register_script( 'foundation-topbar-js', get_template_directory_uri() . '/js/foundation/foundation.topbar.js', array( 'jquery' ), '', true );

    // adding Foundation Section file in the footer
    wp_register_script( 'foundation-section-js', get_template_directory_uri() . '/js/foundation/foundation.section.js', array( 'jquery' ), '', true );

    // adding plugins.js file in the footer
    wp_register_script( 'plugins-js', get_template_directory_uri() . '/js/plugins.js', array( 'jquery' ), '', true );

    // adding scripts.js file in the footer
    ...
    wp_enqueue_script( 'foundation-section-js' );
