<?php
/*
Author: Frank Stallone & Zhen Huang
...
function reverie_theme_support() {
	...
	function reverie_entry_meta() {
		...
		echo '<p class="byline author small">'. __('Written by', 'reverie') .' <a href="'. get_author_posts_url(get_the_author_meta('ID')) .'" rel="author" class="fn">'. get_the_author() .'</a></p>';
	}
